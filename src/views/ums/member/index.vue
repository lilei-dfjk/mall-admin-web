<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="会员名称：">
            <el-input v-model="listQuery.userName" class="input-width" placeholder="会员名称"></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()">添加会员</el-button>
    </el-card>
...
<script>
  import {fetchList,deleteMember,createMember,viewMember,updateMember} from '@/api/member';
